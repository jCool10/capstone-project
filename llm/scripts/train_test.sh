accelerate launch test.py \
        --train_file "/Users/lochoang/Documents/Workspaces/capstone-project/llm/data/databricks-dolly-15k/databricks_dolly15k.json" \
        --each_train_file_percentage 100 \
        --val_file "/Users/lochoang/Documents/Workspaces/capstone-project/llm/data/databricks-dolly-15k/databricks_dolly15k.json" \
        --test_file "/Users/lochoang/Documents/Workspaces/capstone-project/llm/data/databricks-dolly-15k/databricks_dolly15k.json" \
        --lora_r 64 \
        --output_dir "./" \
