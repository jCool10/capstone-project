...
CUDA_VISIBLE_DEVICES=0 accelerate launch --config_file "src/models/configs/config_defaultSingleGPU.yaml" test.py \
        ...
        --minimum_free_spaces 2 \
        --gradient_accumulation_steps 32 \
        --generative_eval_batch_size 1 \
        --max_eval_generative_samples 5 \
        --perplexity_eval_batch_size 1 \
        --max_eval_perplexity_samples 100 \
        --lora_alpha 64 \
        ...
        --no_split_module_classes "LlamaDecoderLayer" "LlamaAttention" "LlamaMLP" "LlamaRotaryEmbedding" \
