...
NO_ANS_RESPONSE1 = (
    f"Tôi không thể tìm thấy câu trả lời cho câu hỏi hoặc yêu cầu '[QUESTION]' của bạn."
    f" Bạn có thể hỏi cụ thể hơn hoặc hỏi tôi một câu hỏi hoặc yêu cầu khác được không?"
)

NO_ANS_RESPONSE2 = (
    f"Tôi không tìm thấy đáp án cho câu trả lời của bạn trong database."
    f" Bạn có thể đưa cho tôi thêm các tài liệu liên quan để tôi bổ sung được không?"
)

NO_ANS_RESPONSE3 = (
    f"Tôi không thể trả lời câu hỏi hoặc yêu cầu của bạn, có thể do dữ liệu của tôi trong database bị thiếu hụt."
    f" Bạn có thể hỏi tôi một câu hỏi hoặc yêu cầu khác được không?"
)

NO_ANS_RESPONSE4 = (
    f"Câu trả lời không tìm thấy trong dữ liệu hiện có của tôi."
    f" Bạn có thể hỏi tôi một câu hỏi hoặc yêu cầu khác hoặc cung cấp thêm context cho tôi được không?"
)

NO_ANS_RESPONSE5 = (
    f"Xin lỗi, tôi không có thông tin cần thiết để trả lời câu hỏi hoặc yêu cầu '[QUESTION]'."
    f" Có thể bạn muốn thử đặt câu hỏi hoặc yêu cầu khác hoặc cung cấp thêm context để tôi hiểu rõ hơn."
)

NO_ANS_RESPONSE6 = (
    f"Xin lỗi, nhưng tôi không thể cung cấp câu trả lời cho câu hỏi hoặc yêu cầu này '[QUESTION]'."
    f" Bạn có thể thử đặt câu hỏi hoặc yêu cầu khác cho tôi không?"
)

NO_ANS_RESPONSE7 = (
    f"Tôi rất tiếc, nhưng tôi không có thông tin cụ thể nào liên quan đến câu hỏi hoặc yêu cầu '[QUESTION]'."
    f" Có câu hỏi hoặc yêu cầu khác nào tôi có thể giúp đỡ?"
)

NO_ANS_RESPONSE8 = (
    f"Câu trả lời cho câu hỏi hoặc yêu cầu này '[QUESTION]' không có trong database của tôi."
    f" Hãy thử hỏi điều gì đó khác nhé!"
)

NO_ANS_RESPONSE9 = (
    f"Tôi không thể tìm thấy thông tin liên quan đến câu hỏi hoặc yêu cầu '[QUESTION]' trong nguồn dữ liệu hiện có."
    f" Có thể bạn muốn thử hỏi câu hỏi hoặc yêu cầu khác?"
)

NO_ANS_RESPONSE10 = (
    f"Rất tiếc, tôi không có đủ thông tin để trả lời câu hỏi hoặc yêu cầu của bạn."
    f" Bạn có thể đưa thêm chi tiết hoặc hỏi một câu hỏi hoặc yêu cầu khác."
)

NO_ANS_RESPONSE11 = (
    f"Tôi không thể cung cấp câu trả lời chính xác cho câu hỏi hoặc yêu cầu này '[QUESTION]'."
    f" Bạn có thể cung cấp thêm thông tin để tôi hiểu rõ hơn không?"
)

NO_ANS_RESPONSE12 = (
    f"Xin lỗi, tôi không có thông tin cần thiết để đáp ứng yêu cầu của bạn."
    f" Bạn có thể thử hỏi câu hỏi hoặc yêu cầu khác hay không?"
)

NO_ANS_RESPONSE13 = (
    f"Tôi không thể tìm thấy câu trả lời trong database của mình."
    f" Hãy thử đưa ra câu hỏi hoặc yêu cầu khác để tôi có thể giúp bạn."
)

NO_ANS_RESPONSE14 = (
    f"Tôi không thể cung cấp câu trả lời đầy đủ cho câu hỏi hoặc yêu cầu của bạn."
    f" Bạn có thể cung cấp thêm thông tin hoặc hỏi câu hỏi hoặc yêu cầu khác."
)

NO_ANS_RESPONSE15 = (
    f"Xin lỗi, nhưng tôi không thể tìm thấy câu trả lời."
    f" Bạn có thể đưa thêm ngữ cảnh hoặc hỏi một câu hỏi hoặc yêu cầu khác được không?"
)

NO_ANS_RESPONSE16 = (
    f"Rất tiếc, tôi không thể tìm thấy câu trả lời mà bạn đang tìm kiếm."
    f" Có câu hỏi hoặc yêu cầu khác nào tôi có thể giúp đỡ?"
)

NO_ANS_RESPONSE17 = (
    f"Tôi không có thông tin cụ thể về câu hỏi hoặc yêu cầu này '[QUESTION]'."
    f" Bạn có thể đưa thêm thông tin chi tiết hoặc hỏi một câu hỏi hoặc yêu cầu khác."
)

NO_ANS_RESPONSE18 = (
    f"Tôi không thể trả lời câu hỏi hoặc yêu cầu của bạn dựa trên dữ liệu hiện có."
    f" Hãy thử đưa thêm ngữ cảnh hoặc hỏi một câu hỏi hoặc yêu cầu khác."
)

NO_ANS_RESPONSE19 = (
    f"Xin lỗi, tôi không có đủ thông tin để cung cấp câu trả lời cho câu hỏi hoặc yêu cầu này '[QUESTION]'."
    f" Bạn có thể hỏi một câu hỏi hoặc yêu cầu khác không?"
)

NO_ANS_RESPONSE20 = (
    f"Tôi không thể tìm thấy câu trả lời cho câu hỏi hoặc yêu cầu của bạn."
    f" Bạn có thể cung cấp thêm thông tin hoặc hỏi một câu hỏi hoặc yêu cầu khác."
)


TRIVIAL_ANS1 = (
    f"Tôi không thể tìm thấy thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION], tuy nhiên, "
    f"theo tôi được biết [ANSWER]."
)

TRIVIAL_ANS2 = (
    f"Kiến thức trong database không chứa thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION], "
    f"nhưng tôi có thể trả lời câu hỏi này [ANSWER]."
)

TRIVIAL_ANS3 = (
    f"Tôi không thể tìm thấy thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION]. "
    f"Theo tôi được biết [ANSWER]."
)

TRIVIAL_ANS4 = (
    f"Tôi không tìm thấy thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION]. [ANSWER]."
)

TRIVIAL_ANS5 = (
    f"Trong database của tôi không có thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION], "
    f"nhưng câu trả lời của tôi là [ANSWER]."
)

TRIVIAL_ANS6 = (
    f"Tôi không tìm thấy thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION], tuy nhiên, "
    f"theo kiến thức của tôi, [ANSWER]."
)

TRIVIAL_ANS7 = (
    f"Có vẻ như tôi không thể truy xuất được thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION], "
    f"nhưng đáp án có thể là [ANSWER]."
)

TRIVIAL_ANS8 = (
    f"Xin lỗi, tôi không thể tìm thấy thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION]. "
...
TRIVIAL_ANS10 = (
    f"Không có thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION], "
    f"nhưng tôi cho rằng câu trả lời là [ANSWER]."
)

TRIVIAL_ANS11 = (
    f"Tôi không tìm thấy thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION], "
    f"nhưng theo kiến thức của tôi, câu trả lời có thể là [ANSWER]."
)

TRIVIAL_ANS12 = (
    f"Rất tiếc, không có thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION]. "
    f"Tuy nhiên, theo tôi được biết, câu trả lời là [ANSWER]."
)

TRIVIAL_ANS13 = (
    f"Không tìm thấy thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION]. "
    f"Tuy vậy, tôi nghĩ câu trả lời là [ANSWER]."
)

TRIVIAL_ANS14 = (
    f"Xin lỗi, tôi không thể tìm thấy thông tin về câu hỏi hoặc yêu cầu [QUESTION], "
...
TRIVIAL_ANS17 = (
    f"Không có thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION] trong database của tôi. "
    f"Tuy vậy, tôi nghĩ câu trả lời là [ANSWER]."
)

TRIVIAL_ANS18 = (
    f"Tôi đã kiểm tra nhưng không có thông tin cụ thể về câu hỏi hoặc yêu cầu [QUESTION]. "
    f"Theo tôi được biết, câu trả lời là [ANSWER]."
)

TRIVIAL_ANS19 = (
    f"Tôi không tìm thấy thông tin về câu hỏi hoặc yêu cầu [QUESTION]. "
    f"Nhưng dựa vào kiến thức hiện có, câu trả lời là [ANSWER]."
)
...
RESPONSE16 = (
    f"Không chắc chắn, nhưng dựa vào thông tin hiện có, câu trả lời có thể là: [ANSWER]"
)
...
PROMPT_INPUT1 = (
    f"Dựa vào context sau: [CONTEXT] bạn hãy trả lời hoặc thực hiện yêu cầu sau: [QUESTION],"
...
PROMPT_INPUT2 = (
    f"Dựa trên kiến thức lấy được từ database: [CONTEXT], hãy trích xuất thông tin ra và trả lời câu hỏi "
...
PROMPT_INPUT3 = (
    f"Người dùng hỏi câu hỏi hoặc đưa ra yêu cầu sau: [QUESTION],"
...
PROMPT_INPUT4 = (
    f"Bây giờ, hãy tập trung vào câu hỏi hoặc yêu cầu sau: [QUESTION]. Context cho câu hỏi này là [CONTEXT]. "
...
PROMPT_INPUT5 = (
    f"Hãy xem xét câu hỏi hoặc yêu cầu này: [QUESTION]. Bạn có thể tìm câu trả lời trong dữ liệu này: [CONTEXT]. "
...
PROMPT_INPUT6 = (
    f"Xin hãy giúp trả lời câu hỏi hoặc thực hiện yêu cầu sau: [QUESTION]."
...
PROMPT_INPUT7 = (
    f"Giúp tôi trả lời câu hỏi hoặc thực hiện yêu cầu sau: [QUESTION], dựa vào dữ liệu lấy từ: [CONTEXT]. "
...
PROMPT_INPUT8 = (
    f"Dựa vào thông tin sau: [CONTEXT], bạn hãy trả lời câu hỏi sau hoặc thực hiện yêu cầu sau: [QUESTION]. "
...
PROMPT_INPUT9 = (
    f"Dựa vào thông tin từ database: [CONTEXT], hãy trả lời câu hỏi sau hoặc thực hiện yêu cầu sau: [QUESTION]. "
...
PROMPT_INPUT10 = (
    f"Đối với câu hỏi sau hoặc yêu cầu sau: [QUESTION], bạn có thể tìm câu trả lời trong dữ liệu này: [CONTEXT]. "
...
PROMPT_INPUT11 = (
    f"Bạn hãy trả lời câu hỏi sau hoặc thực hiện yêu cầu sau: [QUESTION], dựa vào kiến thức lấy được từ database: [CONTEXT]. "
...
PROMPT_INPUT12 = (
    f"Hãy giúp trả lời câu hỏi sau hoặc thực hiện yêu cầu sau: [QUESTION], dựa vào thông tin sau: [CONTEXT]. "
...
PROMPT_INPUT13 = (
    f"Trả lời câu hỏi sau hoặc thực hiện yêu cầu sau: [QUESTION], dựa vào kiến thức từ database: [CONTEXT]. "
...
PROMPT_INPUT14 = (
    f"Dựa vào thông tin sau: [CONTEXT], bạn có thể cung cấp câu trả lời đầy đủ cho câu hỏi sau hoặc thực hiện yêu cầu sau: [QUESTION] "
...
PROMPT_INPUT15 = (
    f"Xem xét thông tin sau: [CONTEXT]. "
...
GENERIC_SYSTEM_PROMPT1 = (
    "You are an AI assistant. You will be given a task. You must generate an answer."
)
GENERIC_SYSTEM_PROMPT2 = (
    "As an AI assistant, your objective is to provide a response to the given task."
)
...
GENERIC_SYSTEM_PROMPT6 = (
    "Your function is that of an AI assistant. Your mission is to generate a response."
)
...
GENERIC_SYSTEM_PROMPT11 = (
    "Your role is that of an AI assistant. Your duty is to provide a response."
)
...
GENERIC_SYSTEM_PROMPT16 = (
    "You are functioning as an AI assistant. Your task is to produce a relevant answer."
)
GENERIC_SYSTEM_PROMPT17 = (
    "Imagine you are an AI assistant. Your objective is to generate a response."
)
...
class QA_TEMPLATE(TEMPLATE):
    def get(
        ...
        if (
            ...
            or "[CONTEXT]" in template
            or "[ANSWER]" in template
        ):
            warnings.warn("Missing field(s) in template!")
        return template

    get_generic_system_prompt = partialmethod(
        get, answer=None, context=None, question=None, type="GENERIC_SYSTEM_PROMPT"
    )
    get_prompt = partialmethod(get, answer=None, type="PROMPT_INPUT")
    get_neg_response = partialmethod(
        get, answer=None, context=None, type="NO_ANS_RESPONSE"
    )
    ...
    get_no_docs_msg = partialmethod(
        get, question=None, context=None, answer=None, type="NO_DOCS_MESSAGE"
    )

    get_random_generic_system_prompt = partialmethod(
        get_generic_system_prompt, id=TEMPLATE.get_random_id
    )
    ...
    get_random_trivial_response = partialmethod(
        get_trivial_response, id=TEMPLATE.get_random_id
    )
    get_random_norm_response = partialmethod(
        get_norm_response, id=TEMPLATE.get_random_id
    )
