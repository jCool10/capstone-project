#!/usr/bin/env python3
"""
OpenOrca VinAI Parser
This script demonstrates how to parse and translate the Open-Orca/OpenOrca dataset
...
class OpenOrca(DataParser):
    """
    OpenOrca DataParser using VinAI provider for high-quality English to Vietnamese translation.
    This parser processes the Open-Orca/OpenOrca dataset and translates it using the
    ...
    def __init__(
        ...
        """
        Initialize the OpenOrca VinAI parser.
    ...
    def read(self) -> None:
        """
        Read the Open-Orca/OpenOrca dataset from HuggingFace.
        """
        # Call parent read function for validation
        super(OpenOrca, self).read()
    ...
    def convert(self) -> None:
        ...
        for split in self.data_read:
            ...
            for data in tqdm(split_data, desc=f"Converting {split} data"):
                ...
                # Store system message if available
                data_dict["system_message"] = data.get("system_message", "")
