#!/usr/bin/env python3
"""
MathInstruct VinAI Parser
This script demonstrates how to parse and translate the TIGER-Lab/MathInstruct dataset
...
PARSER_NAME = "MathInstruct"


class MathInstruct(DataParser):
    """
    MathInstruct DataParser using VinAI provider for high-quality English to Vietnamese translation.
    This parser processes the TIGER-Lab/MathInstruct dataset and translates it using the
    ...
    def __init__(
        ...
        """
        Initialize the MathInstruct VinAI parser.
    ...
    def read(self) -> None:
        """
        Read the TIGER-Lab/MathInstruct dataset from HuggingFace.
        """
    ...
    def convert(self) -> None:
        ...
        for split in self.data_read:
            ...
            for data in tqdm(split_data, desc=f"Converting {split} data"):
                ...
                data_dict["source"] = data.get("source", "")
...
if __name__ == "__main__":
    ...
    math_instruct_parser = MathInstruct(
